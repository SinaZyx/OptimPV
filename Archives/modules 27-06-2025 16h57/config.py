...
class ConfigModule:
    ...
    def initialize_default_config(self):
        ...
        st.session_state.config = {
            ...
            "placement_tresorerie_active": True,  # Activer la gestion des placements
            "pourcentage_tva_a_placer": 80.0,  # % du remboursement TVA à placer
            ...
            if st.session_state.config["with_loan"]:
                 ...
                 **Objectif** : Optimiser uniquement :
                 ...
                 placement_active = st.checkbox(
                     ...
                     value=config.get("placement_tresorerie_active", True),
