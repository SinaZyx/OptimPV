...
def display_cash_flow_statement_restructured(results: dict | None, selected_year: int):
    ...
    for item_cfg_display in config_structure:
        ...
        if item_id_display in ['placement_tva_mois', 'placement_provision_onduleur_mois', 'interets_percus_mois', 
                              'tresorerie_non_placee_fin', 'total_placements_fin', 'vat_net_payment']:
