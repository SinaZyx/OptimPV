...
# Import du module de visualisation moderne
try:
    # Essayer d'importer la nouvelle interface moderne
    ...
    if MODERN_UI_AVAILABLE:
        ...
        print("⚠️ Interface de visualisation classique chargée (mode compatibilité)")
