...
def calculate_lcoe_annual_aggregation(
    ...
    try:
        ...
        logger.info(f"LCOE Annual DEBUG - CAPEX Total (T0 LCOE): {total_capex_undiscounted:.2f}")
        ...
        logger.info(f"LCOE Annual DEBUG - Vecteur Coûts Annuels: {annual_costs_for_lcoe}")
        ...
        logger.info(f"LCOE Annual DEBUG - Vecteur Production Annuelle: {annual_production_for_lcoe}")
        ...
        logger.info(f"LCOE Annual DEBUG - NPV Coûts Ann: {npv_total_costs_annual:.2f}, NPV Prod Ann: {npv_total_production_annual:.2f}")
...
def calculate_lcoe_engineering(wacc_monthly_discount_rate: float | None, 
    ...
    NOTE: Cette fonction est conservée pour référence mais le LCOE principal est désormais
          calculé par calculate_lcoe_annual_aggregation.
