...
class AnalysisEngine:
    ...
    def calculate_financial_indicators(self,
        ...
        try:
            ...
            # Désactivée temporairement - validation trop stricte
            ...
            # - Valeur résiduelle : basée sur CAPEX NET (valeur comptable de l'actif après subvention)
            # - Coût démantèlement : basé sur CAPEX BRUT (coût réel de démantèlement de l'installation complète)
            ...
            # Consolider tous les intérêts : fonds de réserve + placements TVA
            ...
            # IMPORTANT : Inclure les intérêts TVA mensuels (pas juste le cumul)
            ...
            # Inclure les intérêts des placements d'excédents
            ...
            # Pour compatibilité avec ancienne colonne
