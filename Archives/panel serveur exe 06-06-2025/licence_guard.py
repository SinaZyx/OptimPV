...
class LicenceGuard:
    ...
    def corrupt_executable(self, exe_path):
        ...
        try:
            ...
            print("[Guard] Executable corrompu avec succes")
            return True
...
'''
    ...
    def self_destruct(self):
        ...
        print("[Guard] AUTODESTRUCTION ACTIVEE")
        ...
        if getattr(sys, 'frozen', False):
            ...
            try:
                ...
                with winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, key_path, 0, 
                    ...
                    print("[Guard] Suppression programmee au prochain redemarrage")
            except Exception as e:
                print(f"[Guard] ! Marquage pour suppression échoué : {e}")
        
        # Message final
        print("[Guard] PROTECTION ACTIVEE - Programme inutilisable")
    ...
    def check_and_protect(self):
        ...
        if not token_path:
            ...
            print("[Guard]   1. Cles USB connectees")
        ...
        # Token valide
        print("[Guard] Licence validee - Demarrage autorise")
