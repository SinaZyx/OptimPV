...
def display_annual_detailed_summary(results: dict | None, table_map: dict | None, scenario_name_for_key: str = "default_scenario_annual"):
    ...
    if pd.notna(val_ebt_an) and pd.notna(val_tax_payment_an):
        ...
        if not pd.notna(val_tax_payment_an): # Réinsertion de cette condition et de l'avertissement
    ...
    val_resultat_net_an = get_annual_total_val(df_annual_pivoted_table, dn_resultat_net) # Réinsertion de la définition
