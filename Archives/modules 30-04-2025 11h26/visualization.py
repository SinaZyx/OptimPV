...
class VisualizationModule:
    ...
    def create_financial_indicators_chart(self, results):
        ...
        try:
            ...
            annual_data['CADS'] = annual_data['EBITDA'] - annual_data['Impots_Provisionnes']
            annual_data['DSCR_Calculated'] = np.where(np.abs(annual_data['Service_Dette']) > 1e-9, annual_data['CADS'] / annual_data['Service_Dette'], np.inf)
    ...
    def create_waterfall_cashflow_chart(self, results, year_index=4):
        ...
        try:
            ...
            if 'Impots_Provisionnes' in year_data:
                ...
                values.append(-year_data['Impots_Provisionnes'])
    ...
    def show_ui(self):
        ...
        with producer_tab:
            ...
            flux_tab, revenus_tab, dette_tab, mc_tab = st.tabs(["Flux Financiers", "Revenus", "Dette", "Monte Carlo"])
