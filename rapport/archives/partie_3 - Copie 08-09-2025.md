...
L'analyse des factures 2024 révèle une consommation globale de 752,3 MWh/an répartie sur les 5 entrepôts. Mandelieu-la-Napoule, siège social, consomme 467,3 MWh/an constituant le site principal. Le Cannet, Gattières et Mouans-Sartoux présentent chacun 65 MWh/an, tandis qu'Antibes affiche 90 MWh/an et sera retenu comme site pilote selon les factures EPP réelles.
...
![Figure 5.1 : Diagramme de Gantt - Planning projet Antibes 10 mois](./Images/figure_5_1_gantt_antibes.svg)
...
Comme établi en Partie 1, le CAPEX représente 86,9% des coûts totaux de l'autoconsommation collective sur 20 ans (166,118€ CAPEX versus 25,000€ OPEX cumulé), constituant le poste de coût le plus critique pour la viabilité économique des projets. Face à ce pourcentage déterminant, la stratégie de sélection des matériels devient un facteur clé de succès pour le modèle opérateur EaaS.
...
Pour Euro Plomberie-Piscine, ce modèle serviciel sans investissement client nécessite une optimisation CAPEX déterminant directement la capacité à proposer un prix attractif (objectif : 30% d'économie versus 26 c€/kWh actuel) tout en maintenant la rentabilité opérateur avec un TRI de 13,6%.
...
#### Comment intégrer les aides régionales PACA dans le modèle ?
...
L'intégration des aides régionales PACA transforme fondamentalement l'économie du projet selon deux dispositifs cumulables validés par OptimPV. Sud PV Plus apporte 25% du CAPEX éligible plafonné à 130 000€, soit 36,530€ sur l'investissement de 166,118€. EFICAS finance 65% des coûts d'étude PME éligibles, soit 3,617€ sur 5,564€ de prestations techniques.

Le cumul des aides atteint 40,147€ (36,530 + 3,617) représentant 24,2% du CAPEX total, réduisant l'investissement net à 125,971€ versus 166,118€ initial. Cette subvention publique transforme la rentabilité : le TRI bondit de 13,6% à 18,9% (+5,3 points), la VAN s'améliore de 64 113€ à 97 234€ (+33 121€), et le payback s'accélère de 8,2 à 6,1 ans (-2,1 ans).
...
#### Comment comparer les scénarios avec et sans aides publiques ?
...
La validation des seuils de rentabilité confirme la robustesse du modèle EPP selon trois niveaux d'exigence croissants. Le seuil minimal (TRI 8%) est largement dépassé dans tous les scénarios : 13,6% sans aides, 18,9% avec aides PACA. Cette marge de sécurité de +5,6 points minimum absorbe les variations négatives des paramètres critiques.
...
L'étude PVSOL premium 2025 fournit une base technique solide intégrant 448 modules Jinko Solar et 5 onduleurs Huawei pour un coût équipement de 1 100€/kWc soit 221,760€. L'optimisation OptimPV incorpore les spécificités de la toiture de 1 400m² EPP, les études d'ingénierie ACC, et le fonds de roulement pour les phases de construction et démarrage commercial.
...
La stratégie d'accompagnement expert financée par EFICAS intègre la sélection d'un bureau d'études expert en autoconsommation collective avec certification spécifique ACC et références projets EaaS, coût intégré dans les 65% EFICAS. L'accompagnement juridique spécialisé mobilise des avocats experts en droit de l'énergie et baux emphytéotiques, le retour d'expérience des premiers rendez-vous révélant la complexité des Conventions ACC et les spécificités du modèle EaaS. L'ingénierie financière couvre la structuration du modèle économique EaaS, l'optimisation fiscale et le montage de financement, prestations éligibles EFICAS.
...
Le détail des aides publiques confirme l'optimisation financière avec Sud PV Plus apportant 36,530€ (25% × 146,118€ équipements éligibles) et EFICAS finançant 3,617€ (65% × 5,564€ études CAPEX). Le total des aides s'élève à 40,147€ sur 166,118€, soit 24,2% du CAPEX. Ce tableau illustre le modèle 100% EaaS où EPP n'investit rien, tandis que l'opérateur porte l'intégralité du financement tout en optimisant les aides régionales pour réduire le prix de vente électricité.
...
La convergence des indicateurs OptimPV avec les standards sectoriels confirme la crédibilité financière du projet Antibes. Le TRI de 13,6% se situe dans la fourchette haute des projets EaaS français, reflétant l'optimisation apportée par la méthodologie OptimPV. Le LCOE positionne le projet sur la médiane du marché national, garantissant une compétitivité équilibrée sans sous-valorisation ni surenchère tarifaire.
...
La rentabilité nette remarquable de 44,1% du chiffre d'affaires confirme la performance du secteur EaaS et valide les projections de TRI OptimPV de 13,6%. Cette convergence entre projections théoriques et résultats opérationnels renforce la crédibilité de la méthodologie OptimPV.
...
**Quelle cohérence entre les projections OptimPV Antibes et les résultats terrain ?**

La confrontation des projections OptimPV pour le projet Antibes avec les résultats opérationnels réels de 2026 permet de valider la fiabilité des algorithmes de calcul développés en Partie 2.
...
Cette analyse comparative confirme la crédibilité des projections OptimPV et démontre que les opérateurs EaaS expérimentés atteignent effectivement des performances alignées sur les calculs théoriques. La convergence entre projections et réalisations valide l'approche méthodologique développée en Partie 2, renforçant la confiance dans les outils d'aide à la décision OptimPV.
...
La viabilité sans aide se trouve confirmée par un TRI de 13,6% dépassant largement le seuil de rentabilité de 8%, démontrant que le projet conserve sa rentabilité même sans subventions. Cette robustesse intrinsèque sécurise l'investissement face aux éventuels aléas de politique publique énergétique.
...
Les indicateurs opérateur du projet Antibes confirment la solidité économique du montage. Le TRI opérateur de 13,6% dépasse largement l'objectif de 8% fixé par OptimPV, validant la rentabilité intrinsèque du projet. La VAN opérateur de 64 110€ sur les cash-flows EaaS 20 ans confirme la création de valeur actualisée. Le payback opérateur de 7,6 ans selon le modèle serviciel OptimPV assure un retour sur investissement dans les deux tiers de la période contractuelle. La rentabilité garantie pour EPP s'appuie sur un prix fixe 20 ans évitant la volatilité tarifaire du marché électrique.
...
**Comment les simulations Monte Carlo valident-elles la robustesse du projet ?**

OptimPV lance des simulations Monte Carlo intégrant les variabilités statistiques des paramètres critiques pour valider la robustesse probabiliste du projet. La modélisation s'appuie sur une distribution normale pour la production selon les données PVGIS Antibes, une distribution log-normale pour les prix d'électricité reflétant l'évolution tarifaire, et une distribution uniforme pour les coûts de maintenance capitalisant sur l'expertise 25 ans d'OptimPV.

Les résultats Monte Carlo confirment la solidité statistique du projet avec un TRI moyen de 13,6% cohérent avec les calculs déterministes. La probabilité d'atteindre un TRI supérieur à 8% s'élève à 95,2%, sécurisant largement le seuil de rentabilité. Le percentile 95% représentant le pire cas maintient un TRI de 11,1% même en scénario dégradé. La probabilité de succès globale du projet atteint 95,2%, validant définitivement la robustesse face aux aléas.

Cette analyse confirme la robustesse exceptionnelle du projet face aux variabilités, avec une probabilité de réussite dépassant largement les standards sectoriels d'acceptabilité du risque.
...
L'estimation technique préliminaire révèle une surface moyenne de 1 500 m² par site permettant l'installation de 300 kWc par site. La production estimée varie entre 380 et 420 MWh/an selon l'exposition spécifique de chaque bâtiment. Le CAPEX estimé oscille entre 240 et 280 k€ par site, représentant un coût de 800 à 950€/kWc selon la configuration retenue.

La rentabilité prévisionnelle, établie sur des estimations larges, présente un TRI estimé de 10 à 15% selon le contexte local et le marché ACC du périmètre considéré. La VAN sur 20 ans s'échelonne entre 80 et 150 k€ par site selon l'optimisation commerciale développée. Le payback varie de 6 à 9 ans selon les conditions de financement et les aides disponibles localement.
...
**Quelle stratégie optimale OptimPV identifie-t-il pour le déploiement ?**

La stratégie optimale identifiée par OptimPV s'articule autour d'un déploiement séquencé sur quatre phases permettant une montée en puissance maîtrisée et une optimisation progressive du modèle économique.

La Phase 1 (2025) concentre l'effort sur Antibes comme projet pilote, validant l'ensemble du modèle EaaS+ACC développé dans cette thèse. Cette première réalisation sécurise les processus opérationnels et valide les hypothèses économiques dans des conditions réelles d'exploitation.

La Phase 2 (2026) étend le déploiement au Cannet et Mouans-Sartoux, capitalisant sur l'effet d'échelle naissant. Cette phase permet d'optimiser les coûts opérationnels et de valider la réplicabilité du modèle sur des sites aux caractéristiques légèrement différentes.

La Phase 3 (2027) cible Gattières dans le cadre du développement périurbain, testant l'adaptabilité du modèle à des environnements moins denses. Cette phase valide l'extension géographique et la flexibilité du modèle EaaS+ACC.

La Phase 4 (2028) finalise l'extension avec Mandelieu-la-Napoule, site du siège social, dont le déploiement reste conditionné aux résultats des phases précédentes. Cette approche prudente préserve la rentabilité globale du programme.

Cette approche progressive génère des bénéfices multiples : maîtrise des risques par apprentissage itératif, optimisation des coûts par mutualisation progressive, adaptation stratégique selon les résultats terrain et activation de l'effet d'échelle assurance avec une réduction de 600€ à 350€/an/site dès 5 sites, générant une économie de 250€ par site et par an.
...
La convention ACC combinée au modèle EaaS constitue un montage juridique inédit nécessitant une rédaction sur-mesure. L'absence de modèle standard impose une rédaction spécifique de la Convention ACC intégrant EaaS, générant un délai supplémentaire de 2 mois et un coût à documenter lors du projet. La répartition des consommateurs externes exige une convention tripartite entre EPP, opérateur et consommateurs du périmètre 2 kilomètres, incluant la gestion préventive des défaillances. La jurisprudence de la Cour d'Appel de Bordeaux 2024 confirme l'interdiction de clause résolutoire, empêchant la résiliation automatique du bail.
...
**Quels coûts cachés et contraintes techniques révèle l'analyse terrain ?**

L'analyse terrain révèle des écarts significatifs entre prévisions OptimPV et réalité opérationnelle, nécessitant une révision méthodologique des processus d'estimation.

Les coûts cachés découverts comprennent la mise aux normes électriques préalable, l'assurance spécifique au local commercial et les frais notariaux de convention d'autoconsommation, dont les montants réels devront être documentés précisément lors du projet pour calibrer les futurs estimations.

Les contraintes techniques révélées sur site incluent la détection d'amiante en toiture nécessitant un désamiantage dont le coût dépend du diagnostic détaillé, des limites de structure porteuse imposant des renforcements sur une surface à définir, et des difficultés d'accès générant un surcoût de main-d'œuvre dont le pourcentage reste à documenter.

Ces éléments, non détectables par l'analyse cadastrale automatisée OptimPV, créent un écart CAPEX significatif par rapport aux estimations initiales, dont le montant total devra être documenté lors du projet pour améliorer la précision des futurs estimations.
...
La simulation de scénarios pratiques constitue une demande récurrente : "Et si on installe d'abord 50 kWc puis 50 kWc l'année suivante ?", "Quel impact d'une extension future du magasin ?", "Peut-on déplacer des panneaux entre magasins ?". Ces questions révèlent un besoin de modélisation dynamique et évolutive.
...
Le suivi post-installation révèle une lacune majeure d'OptimPV qui se limite à l'étude initiale. Euro Plomberie interroge : "Comment suivre si les performances sont conformes aux prévisions ?". Cette demande légitime nécessiterait un module de monitoring comparant production réelle versus prévisions théoriques.
...
Lors des échanges avec la direction Euro Plomberie, une question récurrente émerge : "Comment nos employés des 5 magasins verront-ils concrètement leurs économies ?" Cette interrogation révèle une lacune fondamentale d'OptimPV concernant l'absence totale d'interface pour les utilisateurs finaux de l'autoconsommation collective.

OptimPV excelle remarquablement dans l'étude de faisabilité mais s'arrête brutalement à la mise en service, créant une rupture dans l'expérience utilisateur. Les 47 salariés d'Euro Plomberie, futurs bénéficiaires de l'ACC, se trouvent dépourvus de tout moyen pour visualiser leurs économies énergétiques individuelles, comprendre le mécanisme de répartition des bénéfices, suivre l'impact environnemental de leur participation ou comparer leurs performances avec les autres sites de manière anonymisée.

Cette limitation transforme l'autoconsommation collective en "boîte noire" totalement opaque pour les utilisateurs finaux, compromettant gravement l'adhésion et l'engagement nécessaires au succès pérenne du projet.

#### Applications utilisateur existantes : benchmark et lacunes

**Quel panorama révèle l'analyse du marché des applications ACC ?**

L'analyse du marché révèle quelques tentatives dispersées d'applications dédiées à l'autoconsommation collective, mais aucune ne répond aux besoins spécifiques identifiés. MySmartBattery développée par Saft se limite exclusivement au stockage résidentiel sans dimension collective. Enerplan Monitor propose une interface B2B uniquement, excluant tout accès utilisateur final. Linky Connect d'Enedis traite les données individuelles sans intégrer la dimension collective pourtant essentielle à l'ACC.

Cette analyse confirme qu'aucune solution ne répond spécifiquement aux besoins des participants ACC multi-sites comme Euro Plomberie. Cette carence manifeste crée une opportunité stratégique significative pour le développement d'un module complémentaire à OptimPV, répondant à un besoin de marché non satisfait.

### 11.2. Conception d'une application utilisateur ACC

#### Fonctionnalités essentielles identifiées

**Quel cahier des charges dessinent les échanges avec Euro Plomberie ?**

Les échanges approfondis avec Euro Plomberie permettent de dresser un cahier des charges précis pour une application utilisateur répondant aux besoins réels du terrain.

Le dashboard personnel constitue le cœur fonctionnel de l'application avec l'affichage des économies mensuelles réalisées comparées à une facture EDF théorique, l'évolution sur 12 mois glissants intégrant la saisonnalité, la répartition entre production solaire consommée et injection réseau, ainsi que l'impact environnemental personnel quantifié en kilogrammes de CO2 évités.

Les comparaisons collectives anonymisées dynamisent l'engagement par un classement des 5 magasins selon leur taux d'autoconsommation, un challenge mensuel "magasin le plus éco-responsable", la comparaison entre moyenne collective et performance individuelle, et la définition d'objectifs communs comme l'atteinte de 80% d'autoconsommation groupe.

La pédagogie énergétique accompagne les utilisateurs par une explication simplifiée du fonctionnement ACC, des conseils d'optimisation de consommation personnalisés selon les profils, des alertes en cas de consommation anormale signalant des oublis d'éclairage ou de climatisation, et une newsletter mensuelle diffusant les actualités du projet.

#### Architecture technique envisagée

**Quelle architecture technique optimale pour l'application utilisateur ACC ?**

L'application s'appuierait judicieusement sur l'infrastructure OptimPV existante, créant des synergies techniques et économiques significatives.
